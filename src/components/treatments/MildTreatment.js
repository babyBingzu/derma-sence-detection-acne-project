    ...
    return (
        <div className="treatment-page">
            ...
            <div className="treatment-content">
                ...
                <ul>
                    <li>ล้างหน้าวันละ 2 ครั้งด้วยผลิตภัณฑ์ที่เหมาะกับสภาพผิว</li>
                    <li>ใช้ผลิตภัณฑ์ที่มีส่วนประกอบ เช่น Benzoyl Peroxide ความเข้มข้น 2.5% , Salicylic Acid ความเข้มข้น 0.5-2%</li>
